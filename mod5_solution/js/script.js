...
dc.loadAbout = function () {
  ...
  //$ajaxUtils.sendGetRequest();
   ...
   buildAndShowAboutHTML(getRandomStarRating());
};

// Return random digit between 1-5 inclusively
...
function buildAndShowAboutHTML (rating) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    // Populate innerHTML of main-content
    function (aboutHtml) {
    	...
    	// For 1 to 5...
   		for (var i = 1; i < 6; i++) {
   			...
   			// If i is less than or equal to rating...
   			if (i <= rating) {

   				// Replace placeholder with full star
   		...
   		// Intailize rating message
   		var ratingMsg = "<span id=\"aboutRating\"> " + rating + "-star rating<span>"
   		// Concatenate strings
   		html += ratingMsg;

   		// Fill innner html of main-content
